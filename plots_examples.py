...
from pol_img_functions import  azimuth_mapping,elevation_mapping,pixel_map_func,pol_2_equirect,gauss_filter_function
...
plt.savefig("blend_high_fig.png", dpi = 300,bbox_inches = "tight")
plt.show()
